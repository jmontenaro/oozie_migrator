...
class CDEResource:
    ...
    def __init__(self, JOBS_API_URL, WORKLOAD_USER, cde_prefix, cde_resource_name):
    ...
    def create_cde_resource(self, token, resource_name):
        ...
        myobj = {"name": self.cde_prefix + "_" + str(resource_name)}
    ...
    def upload_file(self, resource_name, job_path, file_name, token):
        ...
        PUT = '{jobs_api_url}/resources/{resource_name}/{file_name}'.format(jobs_api_url=os.environ["JOBS_API_URL"], resource_name=self.cde_prefix + "_" + resource_name, file_name=file_name)
