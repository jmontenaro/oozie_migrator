...
class OozieWorkflow:
    ...
    def create_workflow_props(self):
    ...
    def replace_workflow_props(self, workflow_d, properties_dict):
    ...
    def replace_query_props(self, properties_dict):
